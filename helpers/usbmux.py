...
import socket, struct, select, sys, biplist
...
class PlistProtocol(BinaryProtocol):
    ...
    def sendpacket(self, req, tag, payload={}):
        ...
        BinaryProtocol.sendpacket(self, self.TYPE_PLIST, tag, biplist.writePlistToString(payload))
    ...
    def getpacket(self):
        ...
        payload = biplist.readPlistFromString(payload)
